...
class UserCertificationOwner extends Model
{
    const CHECK_STATUS_ONGOING = 1;// 待审核
    const CHECK_STATUS_SUCCESS = 2;// 通过
    const CHECK_STATUS_FAILURE = 3;// 驳回
    const HOME_PAGE_TYPE = 'user_certification_owner';

    protected $table = 'user_certification_owner';
    ...
    */
    ...
    public function contracts(){
        return $this->hasMany('App\Models\CertificationContract', 'certification_owner_id', 'id');
    }
